...
const getThumbnailFilename = (fileId: string) => {
  const normalized = fileId.split('?')[0].split('#')[0]
      ...
      <div className="absolute top-2 right-2 z-20">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button aria-label="Acciones del programa" className="p-1.5 bg-white/90 backdrop-blur-sm rounded-full hover:bg-white transition-all shadow-md">
