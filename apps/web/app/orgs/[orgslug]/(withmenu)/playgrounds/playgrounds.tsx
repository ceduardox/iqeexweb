            ...
            <div className="flex flex-col space-y-2 mb-2">
                ...
                <div className="flex items-center gap-3 mb-4 flex-wrap">
                  <div className="relative w-full sm:w-80">
                    ...
                    <input
                      ...
                      aria-label={t('playgrounds_ui.search_label')}
              ...
              {searchQuery && (
                <div className="mb-2 text-sm text-gray-500">
                  {filtered.length === 1
                    ? t('playgrounds_ui.search_results', { count: filtered.length, query: searchQuery })
                    : t('playgrounds_ui.search_results_plural', { count: filtered.length, query: searchQuery })}
                </div>
              )}
                ...
                {filtered.length === 0 && searchQuery && (
                  <div className="col-span-full flex flex-col justify-center items-center py-12 px-4">
                    ...
                    <h2 className="text-xl font-semibold text-gray-600 mb-2">
                      {t('playgrounds_ui.no_results_title', { query: searchQuery })}
                    </h2>
        ...
        >
          ...
          >
            ...
            <div className="flex gap-2 justify-end">
              ...
              >
                {isCreating ? t('playgrounds_ui.creating') : t('playgrounds_ui.create')}
              </button>
            </div>
          </div>
        </div>
